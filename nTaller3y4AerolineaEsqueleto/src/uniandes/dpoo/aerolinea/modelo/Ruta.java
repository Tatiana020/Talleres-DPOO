...
public class Ruta
{
	...
	public int getDuracion() {
	    ...
	    if (horasLlegada < horasSalida) {
	        ...
	        duracionEnMinutos = (horasLlegada + 24 - horasSalida) * 60 + minutosLlegada - minutosSalida;
	    } else {
	        duracionEnMinutos = (horasLlegada - horasSalida) * 60 + minutosLlegada - minutosSalida;
	    }
